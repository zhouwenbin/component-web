...
(function(e, t) {
  ...
  function() {
    ...
    return n.Construct.extend({
      ...
      validate: function() {
        if (this.api) {
          ...
          for (var e in this.api.REQUIRED)
            if (!r.has(this.data, e)) return new Error("缺少必填字段" + e)
        }
        return this.api.SECURITY_TYPE === o.UserLogin && !this.checkUserLogin() ? (this.goToLogin(), new Error("该请求需要在登录后发起")) : !0
      },
      ...
      request: function(e, t) {
        ...
        return n.ajax({
          ...
          i.access(n, t) ? (i.afterRequest(e._mt, n.content[0]), r.resolve(n.content[0])) : n.stat.stateList.length == 0 ? r.reject(n.stat.code) : r.reject(n.stat.stateList[0].code)
        }).fail(function(e) {
          r.reject(e)
        }), r
      },
  ...
  }), define("sf.b2c.mall.api.logistics.getUserRoutes", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "logistics.getUserRoutes",
        SECURITY_TYPE: i.UserLogin,
        REQUIRED: {
          orderId: "string"
        },
        OPTIONAL: {},
  ...
  }), define("sf.b2c.mall.api.products.getSKUBaseList", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "product.getSKUBaseList",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          skulist: "string"
        },
        OPTIONAL: {},
  ...
  }), define("sf.b2c.mall.api.products.getSKUInfo", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "product.getSKUInfo",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          sku: "string"
        },
  ...
  }), define("sf.b2c.mall.api.products.getSPUInfo", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "product.getSPUInfo",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          spu: "string"
        },
  ...
  }), define("sf.b2c.mall.api.products.updateSkuSellStock", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "product.updateSkuSellStock",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          sku: "string",
          count: "int"
  ...
  }), define("sf.b2c.mall.api.products.getAllParents", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "products.getAllParents",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          cid: "long"
        },
  ...
  }), define("sf.b2c.mall.api.products.getCategories", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "products.getCategories",
        SECURITY_TYPE: i.None,
        REQUIRED: {},
        OPTIONAL: {},
        VERIFY: {},
  ...
  }), define("sf.b2c.mall.api.products.search", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "products.search",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          q: "string"
        },
    ...
    return r.extend({
      api: {
        ...
        SECURITY_TYPE: i.RegisteredDevice,
        REQUIRED: {
          accountId: "string",
          type: "string",
          password: "string"
    ...
    return r.extend({
      api: {
        ...
        ERROR_CODE: {
          ...
          1000090: "邀请码错误",
          1000100: "验证码错误",
          1000150: "目前不支持此类型邮箱的注册,只接受顺丰内部邮箱注册",
          1000180: "该邀请码已经被使用"
        }
      }
    })
  ...
  }), define("sf.b2c.mall.api.user.userActivate", ["jquery", "can", "underscore", "sf.b2c.mall.framework.comm", "sf.b2c.mall.api.security.type"], function(e, t, n, r, i) {
    return r.extend({
      api: {
        METHOD_NAME: "user.userActivate",
        SECURITY_TYPE: i.None,
        REQUIRED: {
          mailId: "string",
          tm: "long",
