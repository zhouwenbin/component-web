...
<<<<<<< HEAD
    filterGroup: ['order', 'user', 'logistics', 'product', 'shopcart', 'b2cmall', 'sc', 'supplychain', 'coupon', 'promotion', 'search']
=======
    filterGroup: ['order', 'user', 'logistics', 'product', 'shopcart', 'b2cmall', 'sc', 'supplychain', 'coupon', 'promotion','minicart']
