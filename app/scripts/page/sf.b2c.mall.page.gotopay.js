...
define(
  ...
  function(can, $, helpers, SFFrameworkComm, Header, Footer, OrderSetp, SFOrderFn, SFMessage, GetOrderConfirmInfo) {
    ...
    var order = can.Control.extend({
      ...
      showPayMap: {
        'alipay_intl': '<div class="order-r1c1 fl "><span name="radio-pay" payType="lianlianpay" class="icon radio active"></span><img src="http://img.sfht.com/sfht/1.1.32/img/pay4.jpg" alt="连连支付"><h3>首次使用连连支付下单，立减5元</h3></div>' +
        ...
        'alipay': '<div class="order-r1c1 fl "><span name="radio-pay" payType="lianlianpay" class="icon radio active"></span><img src="http://img.sfht.com/sfht/1.1.32/img/pay4.jpg" alt="连连支付"><h3>首次使用连连支付下单，立减5元</h3></div>' +
