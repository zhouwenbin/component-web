    ...
    return can.Control.extend({
      ...
      renderMap: {
        'fillinfo': function(data) {
          var html = can.view('templates/component/sf.b2c.mall.component.i.register.fillinfo.mustache', data, this.helpers);
        ...
        'success': function(data) {
          var that = this;
          var html = can.view('templates/component/sf.b2c.mall.component.i.register.success.mustache', data, this.helpers);
          this.element.html(html);
        ...
        'confirminfo': function(data) {
          ...
          var html = can.view('templates/component/sf.b2c.mall.component.i.register.confirminfo.mustache', data, this.helpers);
          this.element.html(html)
          this.element.find('.register').fadeIn('slow');
        }
      },
